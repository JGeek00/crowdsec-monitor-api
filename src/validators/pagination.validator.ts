...
export const paginationValidators: ValidationChain[] = [
  ...
  query('unpaged').optional().isBoolean().withMessage('unpaged must be a boolean (true or false)').toBoolean(),
];
...
export const alertQueryValidators: ValidationChain[] = [
  ...
  query('simulated').optional().isBoolean().withMessage('simulated must be a boolean (true or false)').toBoolean(),
...
export const decisionQueryValidators: ValidationChain[] = [
  ...
  query('scope').optional().isIn(['Ip', 'Range', 'ip', 'range']).withMessage('scope must be one of: Ip, Range'),
  ...
  query('include_decisions')
    .optional()
    .isBoolean()
    .withMessage('include_decisions must be a boolean (true or false)')
    .toBoolean(),
];
