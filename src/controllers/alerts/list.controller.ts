...
import { Alert_EventData, Alert_SourceInfo, Alert, GetAlertsResponse, UnparsedMetaData } from '@/models';
 ...
 */
export async function getAllAlerts(req: Request<{}, {}, GetAlertsResponse, GetAlertsQueryParams>, res: Response): Promise<void> {
