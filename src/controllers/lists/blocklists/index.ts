export { getBlocklists } from '@/controllers/lists/blocklists/list.controller';
export { getBlocklistById } from '@/controllers/lists/blocklists/unique-blocklist.controller';
export { getBlocklistIps } from '@/controllers/lists/blocklists/ips.controller';
